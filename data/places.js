const PLACES = {
  airport: {
    ...
    hours: "24시간",
    price: "무료",
    bestTime: "항공편 도착시간 기준",
    tips: "입국 심사와 수하물 수령 시간을 포함해 시내 이동까지 여유를 두세요.",
    note: "입국 수속과 수하물 수령 후 광저우 시내로 이동합니다.",
    images: [
  ...
  zhanxiMarket: {
    id: "zhanxiMarket",
    name: "잔시루 도매시장",
    chineseName: "站西路批发市场商圈",
    addressZh: "广东省广州市越秀区站西路57号一带",
    category: "도매시장",
    district: "yuexiu",
    duration: 180,
    openTime: "09:00",
    ...
    priority: 7,
    tags: ["도매시장", "의류", "시계", "쇼핑"],
    hours: "시장별 상이 · 대체로 09:00~17:00",
    price: "입장 무료 · 상품 가격 별도",
    bestTime: "오전 09:00~11:00",
    tips: "한 건물이 아니라 여러 도매시장과 상가가 모인 지역입니다. 위조상품의 구매·반입·판매에는 법적 문제가 생길 수 있으니 정품 여부와 반입 규정을 확인하세요.",
    note: "광저우역 서쪽의 의류·신발·시계·액세서리 도매시장 밀집 지역입니다.",
    images: [
      "images/places/zhanxiMarket-1.jpg"
    ]
  },
  ...
  haixinBridge: {
    ...
    name: "하이신차오",
    chineseName: "海心桥",
    addressZh: "广东省广州市海珠区广州塔西侧至越秀区二沙岛东侧",
    category: "보행교",
    district: "zhujiang",
    duration: 60,
    latitude: 23.11086,
    ...
    priority: 9,
    tags: ["야경", "산책", "사진"],
    hours: "07:00~23:00 · 최종 입장 22:45",
    price: "무료",
    bestTime: "일몰 이후",
    tips: "현재 일반 예약은 폐지됐지만, 혼잡 시 현장 인원 통제가 적용될 수 있습니다. 보안검색을 거쳐야 합니다.",
    note: "광저우타워 서쪽과 얼사다오 동쪽을 연결하는 주강 위의 보행교입니다.",
    images: [
      "images/places/haixinBridge-1.jpg"
    ]
  },
  ...
  partyPier: {
    id: "partyPier",
    name: "파티피어",
    chineseName: "珠江琶醍啤酒文化创意艺术区",
    addressZh: "广东省广州市海珠区阅江西路磨碟沙大街118号",
    category: "야경·식음",
    district: "zhujiang",
    duration: 150,
    latitude: 23.10661,
    longitude: 113.340957,
    openTime: "17:00",
    closeTime: "24:00",
    recommendedTime: ["evening", "night"],
    priority: 8,
    tags: ["야경", "레스토랑", "바", "산책"],
    hours: "구역 상시 접근 · 매장별 영업시간 상이",
    price: "입장 무료 · 식음료 별도",
    bestTime: "저녁 18:00 이후",
    tips: "레스토랑과 바의 영업시간은 매장마다 다릅니다. 광저우타워·하이신차오와 같은 날 저녁 동선으로 묶기 좋습니다.",
    note: "주강변 옛 맥주공장 일대를 활용한 문화·식음·야경 명소입니다.",
    images: [
      "images/places/partyPier-1.jpg",
      "images/places/partyPier-2.jpg"
    ]
  },
