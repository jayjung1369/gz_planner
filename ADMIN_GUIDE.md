...
- 모바일에서도 상단에 Planner, Wedding, Travel, Guide 탭이 표시됩니다.
- 화면이 좁으면 탭 영역만 좌우로 스크롤할 수 있습니다.
- 상세보기 닫기 버튼은 사진과 겹치지 않는 독립 상단바에 표시됩니다.
- 이미지가 보이지 않을 경우 `style.css?v=25`가 배포됐는지 확인하세요.
